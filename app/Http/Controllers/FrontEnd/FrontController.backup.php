...
class FrontController extends Controller
{
    ...
    public function index()
    {
        ...
        $categoryutama2 = DB::table('csc_product_home as a')
            ...
            ->get();
        // get news
        $news = DB::table('artikel')->orderby('tanggal', 'desc')->skip(1)->limit(5)->get();
        $artikel = DB::table('artikel')->orderby('tanggal', 'desc')->limit(1)->get();
        $slide = slideshow::all();
    ...
    public function detail($judul_seo)
    {
        ...
        return view('frontend.news.detail-artikel', compact('artikel', 'news', 'pageTitle'));
    }
    ...
    public function list_product(Request $request)
    {
        ...
        return view('frontend.product.list_product', ['product' => $product->appends(Input::except('page'))], compact('categoryutama', 'manufacturer', 'catActive', 'coproduct', 'search', 'get_id_cat', 'sortbyproduct', 'getEks', 'pagenow', 'hot_product', 'hl_sort', 'lct', 'countNew', 'countHot', 'pageTitle', 'topMenu'));
    }
    ...
    public function view_product($id)
    {
        ...
        $data = DB::table('csc_product_single AS a')
            ->select('a.*', 'b.company', 'c.foto_profil')
        ...
        return view('frontend.product.detail_products', compact('data', 'product', 'imgarr', 'smtarr', 'nmtarr', 'rates', 'pageTitle', 'topMenu', 'url_eks', 'url_gambar'));
    }
    ...
    public function research_corner(Request $request)
    {
        ...
        return view('frontend.research-corner', ['research' => $research->appends(Input::except('page'))], compact('page', 'searchEvent', 'param', 'pageTitle', 'topMenu'));
    ...
    public function curris_data(Request $request)
    {
        ...
        return \Yajra\DataTables\DataTables::of($currentissue)
            ...
            ->addColumn('date', function ($data) {
                return date('d M Y', strtotime($data->publish_date)) . ' ( ' . date('H:i', strtotime($data->publish_date)) . ' )';
            })
