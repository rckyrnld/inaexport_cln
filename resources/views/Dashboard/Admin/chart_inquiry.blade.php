<div class="box-body">
    <div class="tab-content p-3 mb-3">
        <div class="tab-content p-3 mb-3">
            <div class="tab-pane animate fadeIn text-muted" id="tab1">
                <div class="row">
                    <div id="user_year" style="min-width: 100%; height: 400px; margin: 0 auto;"></div>
                    <a id="export_pdf_1" class="btn btn-success">
                        <font color="white"><i class="fa fa-download"></i> Export PDF</font>
                    </a>
                </div>
            </div>
            ...
            <div class="tab-pane animate fadeIn text-muted active show" id="tab3">
                <div class="row">
                    <div id="inquiry"
                         style="height: 300px; width: 100%; margin: 0 auto; float: left;"></div>
