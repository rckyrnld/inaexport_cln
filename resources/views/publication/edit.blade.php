            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" name="title_en" autocomplete="off" required
                                placeholder="Input" value="{{ $data->judul_en }}">
                        </div>
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control" name="title_in" autocomplete="off" required
                                placeholder="Input" value="{{ $data->judul }}">
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <select class="form-control select2" id="type" required name="type">
                                ...
                                <option value="Export News"
                                    @if (isset($data)) @if ($data->tipe == 'Export News') selected @endif
                                    @endif >Export News</option>
                                <option value="Warta Ekspor"
                                    @if (isset($data)) @if ($data->tipe == 'Warta Ekspor') selected @endif
                                    @endif >Warta Ekspor</option>
                                <option value="Brochure"
                                    @if (isset($data)) @if ($data->tipe == 'Brochure') selected @endif
                                    @endif >Brochure</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="control-label col-md-2 mt-2 text-lg-right text-sm-left">Tanggal Publish</label>
                        <div class="col-md-4">
                            <input type="date" class="form-control" name="date" autocomplete="off" style="" required
                                placeholder="Input" value="{{ $data->publish_date }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <a href="{{ url('/') . '/uploads/publication/cover/' . $data->cover }}" target="_blank"
                                class="btn btn-outline-secondary"><i class="fa fa-eye"
                                    aria-hidden="true"></i>&nbsp;&nbsp;Cover Sebelumnya</a>
                        </div>
                    </div>
                    <div class="form-group row" style="margin-top: -21px;">
                        ...
                        <div class="col-md-4">
                            <a href="{{ url('/') . '/uploads/publication/file/' . $data->file }}" target="_blank"
