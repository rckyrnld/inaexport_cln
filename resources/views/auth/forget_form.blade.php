...
<div id="content-body" style="background-color: #c5e1f8 ; color: black">
    <center><br><img style="height:70px!Important;" src="{{ asset('front/assets/img/logo/logonew-200.png') }}"
            alt="."></center>
                ...
                <form class="form-horizontal" method="POST" action="{{ url('updatepass1/' . $ri) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input id="password" type="password" placeholder="password" class="form-control"
                            name="password" style="color: #000000" value="" required="" autofocus="">
                    ...
                    <br>
                    <div class="form-group">
                        <center><button style="width: 100%;" type="submit"
                                class="btn btn-primary">@lang("login.btn3")</button></center>
                    </div>
                    <br>
                </form>
