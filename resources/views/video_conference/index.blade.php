...
@section('content')
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group row mb-2 ml-2">
                                        <label for="inputMeetingDuration"
                                            class="col-sm-3 col-form-label font-weight-bold">Duration (in Minute)<span
                                                style="color:#ff0000">*</span></label>
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control minute required create-input"
                                    ...
                                    <div class="form-group row mb-2 ml-2">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control perwadag-quota required create-input"
                                    ...
                                    <div class="form-group row mb-2 ml-2">
                                        <label for="inputBuyerMeetingQuota"
                                            ...
                                            Quota <span style="color:#ff0000">*</span></label>
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control buyer-quota required create-input"
                                    ...
                                    <div class="form-group row mb-2 ml-2">
                                        <label for="inputExportirMeetingQuota"
                                            ...
                                            Quota <span style="color:#ff0000">*</span></label>
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control exportir-quota required create-input"
                        ...
                        <table class="table table-bordered table-striped table-hover" id="meeting-table"
                            ...
                            <tbody>
                                @foreach ($data['meetings'] as $d)
                                    <tr style="background-color: {{ $d['is_passed'] == true ? '#c1c1c1' : 'white' }}">
                                        <td style="text-align: center; vertical-align:middle">{{ $loop->iteration }}</td>
                                        <td style="text-align: center; vertical-align:middle">{{ $d['id'] }}</td>
                                        ...
                                        <td style="text-align: center; vertical-align: middle;">{{ $d['country'] }}</td>
                                            ...
                                            @if (count($d['participants']) > 0)
                                                <span data-toggle="modal" data-target="#exampleModalUserParticipants"
                                                    ...
                                                    <a class="btn btn-primary btn-sm" style="color: white !important;"
                                                        ...
                                                        title="Registered User"><i class="fa fa-eye"></i></a>
                                                </span>
                                            @endif
                                            @if ($d['is_passed'] == true)
                                                <span data-toggle="modal"
                                                    data-target="#exampleModalPotentialTransactionValue"
                                                    class="btn-potential-transaction" data-value="{{ $d['id'] }}">
                                                    <a class="btn btn-primary btn-sm" style="color: white !important;"
                                                        data-toggle="tooltip" data-placement="top"
                                                        title="Potential Transaction Value"><i
    ...
    <!-- Modal -->
    <div class="modal fade" id="exampleModal" aria-labelledby="exampleModalLabel" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary btn-close-invitation" data-dismiss="modal">Close</button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row col-lg-12">
                        <label for="inputPotentialTransactionValue" class="col-sm-3 col-form-label font-weight-bold">Value
                            <span style="color:#ff0000">*</span></label>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success btn-submit-potential-value"><i
                            class="fa fa-save"></i>
                        Save</button>
                </div>
            </div>
