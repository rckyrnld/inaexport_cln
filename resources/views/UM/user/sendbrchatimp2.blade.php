<div align="center" style="width: 100%">
  <div align="center" style="width: 580px;">
    ...
    <p style="text-align: left">Dear Importir, </P>
    <p style="text-align: left">You Was Respond Chat On Buying Request</p>
    <hr>
    <!-- <ol>
        <ul>Name : {{$username}}</ul>
        <ul>Email : {{$email}}</ul>
    ...
    <p style="text-align: left">click <a href="{{url('br_importir_chat', $id)}}">Here</a>.</p>
