        ...
        <div class="col-md-12">
            <div class="box">
               ...
               <table id="example1" class="table table-bordered table-striped">
								...
								<tbody>
								<?php 
								$data = DB::select("select * from notif where status_baca='0' and to_role='1' order by id_notif desc"); 
								$no =1;
								foreach($data as $dt){
								?>
								<tr>
                                    ...
                                    <a class="btn btn-success" onclick="closenotif({{ $dt->id_notif }})" href="{{url($dt->url_terkait)}}">
                                        GO TO LINK</a>
        
									<?php }else{ ?>
                                    <a class="btn btn-success" onclick="closenotif({{ $dt->id_notif }})" href="{{url($dt->url_terkait.'/'.$dt->id_terkait)}}">
                                    GO TO LINK</a>
