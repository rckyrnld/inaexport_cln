                    ...
                    <div class="card-body">
                        ...
                        <div class="col-md-14">
                            <div class="">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="form-row">
                                                            ...
                                                            <div class="col-lg-7 col-md-9 col-sm-11">
                                                                ...
                                                                <label class="text-break">
                                                                    <?php
                                                                    echo getNameCompany($p->id_eks);
                                                                    if (Cache::has('user-is-eksmp-' . $p->id_eks)) {
                                                                        echo ' <label class="text-success font-weight-bold">(Online)</label>';
                                                                    } else {
                                                                        echo ' <label class="text-danger font-weight-bold">(Offline)</label>';
                                                                    }
                                                        ...
                                                        <div class="form-row">
                                                            ...
                                                            <div class="col-lg-7 col-md-9 col-sm-11">
                                                                ...
                                                                <textarea readonly style="color:black;display:none;" name="spec" id="spec"
                                                                    class="form-control"><?php echo $p2->spec; ?></textarea>
                                                            </div>
                                                        ...
                                                        <div class="form-row">
                                                            ...
                                                            <div class="col-lg-7 col-md-9 col-sm-11">
                                                                <label class="text-break">
                                                                    <?php echo number_format($p2->tp, 0, ',', '.'); ?>
                                                                </label>
                                                            ...
                                                            <div class="col-lg-7 col-md-9 col-sm-11">
                                                                <label class="text-break">
                                                                    ...
                                                                    if ($p2->by_role == 1) {
                                                                        ...
                                                                        $usre = DB::select("SELECT a.id_mst_country, b.country FROM csc_buying_request a, mst_country b WHERE a.id_mst_country = b.id and a.id ='" . $p2->id . "'");
                                                                        foreach ($usre as $imp) {
                                                                            echo $imp->country;
                                                                        }
                                                                    }
                                                        ...
                                                        <div class="form-row">
                                                            ...
                                                            <div class="col-lg-7 col-md-9 col-sm-11">
                                                                <label class="text-break">
                                                                    <?php echo date('Y-m-d', strtotime($p2->date)); ?>
                                                                </label>
                                                            </div>
                                                        </div>
                                ...
                                <div align="left"><br><br>
                                    <a href="{{ url('br_pw_lc/' . encrypt($id_br)) }}" class="btn btn-danger">
                                ...
                                <div class="modal fade" id="myModal2" role="dialog">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <form id="formId" action="{{ url('uploadpop4') }}"
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-sm-7">
                                                            ...
                                                            <input type="hidden" class="form-control" name="idb" id="idb"
                                                                value="<?php echo $id_br; ?>">
                                                            <input type="hidden" class="form-control" name="idc" id="idc"
                                                                value="<?php echo Auth::user()->id_role; ?>">
                                ...
                                $compa = '-';
                                $rg = DB::select("select a.name from itdp_admin_users a where a.id='" . Auth::user()->id . "' ");
                                foreach ($rg as $gr) {
                                    $compa = $gr->name;
                                }
                                ...
                                <script>
                                    function kirimchat() {
                                        var a = $('#inputan').val();
                                        var b = $('#id_br').val();
                                        var c = <?php echo Auth::user()->id_group; ?>;
