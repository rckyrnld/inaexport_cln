                            ...
                            <div class="tab-pane fade show active" id="new" role="tabpanel">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12">
                                        <div class="">
                                            <table id="example1" class="table table-striped table-hover" style="width: 100%; table-layout: fixed;" data-plugin="dataTable">
                                                <thead class="text-dark" style="background-color: #6B7BD6;">
                                                    <th width="10%" style="color: white">No</th>
                                                ...
                                                <tbody align="left">
                                                    <?php
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="text-align: left;"><a class="link-company" href="{{ url('front_end/list_perusahaan/view', $ryu->id_user) }}-{{ $ryu->company }}" target="_blank"><?php echo $ryu->company; ?></a></td>
                                                            <!-- <td style="text-align: left;"><?php echo $ryu->addres . ' ,' . $ryu->city; ?></td> -->
                                                            <td style="text-align: left;"><?php echo $ryu->oemail; ?></td>
                                                            <td style="text-align: left;">
                                                                <?php if ($ryu->status_join == null) {
                                                                            echo 'pending';
                                                                        } elseif ($ryu->status_join == '1') {
                                                                            echo 'Waiting for your repply';
                                                            ...
                                                            <td style="text-align: left;">
                                                                ...
                                                                <?php if ($ryu->status_join == 1) { ?>
                                                                    <a href="{{ url('br_konfirm/' . $ryu->idb . '/' . $id) }}" class="btn btn-success" title="Verify"><i class="fa fa-check" style="color: white;"></i></a>
                                                                <?php } else if ($ryu->status_join == 2) { ?>
                                                                    <a href="{{ url('br_importir_chat/' . encrypt($id) . '/' . encrypt($ryu->idb)) }}" class="btn btn-info" title="Chat"><i class="fa fa-comment" style="color: white;"></i></a>
                                                                <?php } else if ($ryu->status_join == 4) { ?>
                                                                    <a href="{{ url('br_importir_chat/' . encrypt($id) . '/' . encrypt($ryu->idb)) }}" class="btn btn-success" title="View"><i class="fa fa-list" style="color: white;"></i></a>
                                                                <?php } ?>
...
<script type="text/javascript">
    function xy(a) {
        ...
        $.get('{{ URL::to('ambilbroad2/')}}/'+ a, { _token: token
            },
            function(data) {
