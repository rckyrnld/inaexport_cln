...
-->
            ...
            <div align="right">
                <a href="{{ url('/inquiry_admin/view/' . $inquiry->id) }}" class="btn btn-danger"
...
<div class="modal fade" id="modalInvoice" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.inquiry.fileChat') }}" method="post" enctype="multipart/form-data"
                id="uploadform">
                {{ csrf_field() }}
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <center>
                    ...
                    <br>
                    <a href="{{ url('/inquiry_admin/dealing/' . $inquiry->id . '/1') }}" class="btn btn-primary"
                        style="width: 100px;">Deal</a>&nbsp;OR
                    &nbsp;<a href="{{ url('/inquiry_admin/dealing/' . $inquiry->id . '/2') }}"
