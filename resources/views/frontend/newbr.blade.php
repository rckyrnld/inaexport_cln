                ...
                <div class="col-md-5">
                    <div class="box-body" style="color:black; font-size:13px;">
                        ...
                        <form class="form-horizontal" method="POST" action="{{ url('br_importir_save') }}"
                            enctype="multipart/form-data" id="form_br" onsubmit="myFunction()">
                            {{ csrf_field() }}
                            <div class="form-row">
                                <div class="col-sm-12">
                                    <center>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-sm-12">
                                    <input type="text" style="color:black;font-size:12px;" value="" name="subyek"
                                        id="subyek" class="form-control" required>
                                </div>
                                <div class="col-sm-12">
                                    <label><b>@lang("login.forms.by3") (<font color="red">*</font>)</b></label> :
                                    {{-- <select name="category" id="category"
                                        class="form-input select span16 J-noselect" cz-css="form-inline span16">
                                        <option class="option" value="unselect" style="display: none; color: menutext;">
                                            Please select</option>
                                        <option value="nhpasQEVtmJx">Construction &amp; Decoration»Building
                                            Glass»Tempered Glass</option>
                                        <option class="option" value="unfind" style="color: menutext;">Don't find?
                                            Choose my category.</option>
                                    </select> --}}
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div id="rec_kat_isi">
                                        ...
                                        for ($i = 0; $i < count($rec); $i++) { $id1=$rec[$i]->id_level_1 != null ?
                                            ...
                                            echo '<input type="radio" class="category_radio"
                                                id="cat_' . $id_category . '" name="category_rec"
                                                value="' . $id_category . '" required>';
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-sm-12">
                                    <div class="form-row">
                                        <div class="col-sm-7">
                                            <input style="color:black;font-size:12px;" value="" type="text" min="1"
                            ...
                            <div class="form-row">
                                <div class="col-sm-12">
                                    <label><b>@lang("login.forms.by6") <span id="fob">(FOB)</span></b></label>
                                </div>
                                <div class="form-group col-sm-12">
                                    <div class="form-row">
                                        <div class="col-sm-7"><input style="color:black;font-size:12px;" type="text"
    ...
    echo number_format($tp, 0, ',', '.');
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-sm-6" style="font-size: 12px !important;">
                                    ...
                                    ?>
                                    <select style="color:black;font-size:12px; height: 40px!important;"
                                        ...
                                        <option value="<?php echo $val2->id; ?>" style="font-size:12px;" @if($val2->id
                                            == $profile->id_mst_country) selected @endif>
                                ...
                                <div class="form-group col-sm-6">
                                    <input style="color:black;font-size:12px;" type="text" value="" name="city"
                            ...
                            <div class="form-row">
                                <div class="col-sm-12">
                                    ...
                                    ?>
                                    <a onclick="simpanbr()" style="width:100%!important;"
                                        class="btn btn-md btn-success rounded">
        ...
        $.ajax({
            ...
            .done(function(data) {
                ...
                $.each(data, function(i, val) {
                    $('#tabelpiliheksportir').DataTable().row.add(['<a href="{{ url('perusahaan') }}/' +
                        val.id + '" target="_blank">' + val.company + '</a>',
