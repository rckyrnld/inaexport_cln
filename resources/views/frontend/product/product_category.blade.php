          ...
          <thead>
            <th colspan="5">
              <?php
                $loc = app()->getLocale();
                  if($loc == "ch"){
                    $titlecategory = $catdata->nama_kategori_chn;
                  }elseif($loc == "in"){
                    $titlecategory = $catdata->nama_kategori_in;
                  }else{
                    $titlecategory = $catdata->nama_kategori_en;
                  }
          ...
          <tr>
            <td colspan="5">
              <div style="float: right;">
                {{ $prodcategory->links('vendor.pagination.bootstrap-4') }}
                {{ $prodcategory->total() == 0 ? Lang::get('frontend.event_zoom.no_result') : '' }}
              </div>
            </td>
          </tr>
          </tbody>
