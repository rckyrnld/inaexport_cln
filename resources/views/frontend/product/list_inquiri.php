                ...
                <div class="col-7">
                    <form method="GET" action="{{url('/products')}}" id="formsprod">
                        <div class="input-group flex-nowrap" style="margin-top: 7px">
                            <?php
                            // if(isset($cari_produk)){
                            //     $cari_produk = $cari_produk;
                            // }else{
                            //     $cari_produk = "";
                            // }
            
                            // if(isset($cari_catnya)){
                            //     $cari_catnya = $cari_catnya;
                            // }else{
                            //     $cari_catnya = "";
                            // }
                            ?>
                            <input style="border-top-left-radius: 15px; border-bottom-left-radius:15px" type="text" class="form-control" placeholder="@lang('frontend.home.cariproduct')" style="border-radius: 0px;" name="cari_produk" value="{{(isset($cari_produk)) ? $cari_produk : ''}}" id="cari_produk">
                            <input type="hidden" name="lctnya" value="{{(isset($lct)) ? $lct : ''}}" id="lctnya">
                            <input type="hidden" name="eks_prod" value="{{(isset($getEks)) ? $getEks : ''}}" id="eks_prod">
                            <input type="hidden" name="hl_prod" value="{{(isset($hl_sort)) ? $hl_sort : ''}}" id="hl_prod">
                            <input type="hidden" name="cari_catnya" value="{{--(isset($get_id_cat)) ? $get_id_cat : ''--}}" id="cari_catnya">
                            <input type="hidden" name="sort_prod" value="{{(isset($sortbyproduct)) ? $sortbyproduct : ''}}" id="sort_prod">
    ...
    <div class="shop_area shop_reverse">
        <div class="container">
            <div class="row">
                    ...
                    <aside class="sidebar_widget" style="border-radius: 20px;">
                        <div class="widget_inner" style="background : #e9e9ff !important">
                            <div class="widget_list widget_categories" style="background : #e9e9ff; !important">
                                ...
                                ?>
                                @if(isset($page))
                                    <input type="text" class="form-control" id="cari_kategori" name="cari_kategori" disabled placeholder="{{$srchcatlang}}" style="    border: 1
                                    px
                                ...
                                <div class="list-group list-group-flush" id="catlist">
                                    @foreach($categoryutama as $cu)
                                        ...
                                        @if(count($catprod1) == 0)
                                            ...
                                            @else
                                            <a href="{{url('/kategori/'.$cu->id.'/'.slugifyTitle($cu->nama_kategori_en).'/')}}" class="list-group-item">{{$cu->$nk}}</a>
                                            @endif
                                        @else
                                            <div class="list-group-item">
                                                ...
                                                @else
                                                <a class="cat-prod" href="{{url('/kategori/'.$cu->id.'/'.slugifyTitle($cu->nama_kategori_en).'/')}}"> {{$cu->$nk}}</a><a onclick="openCollapse(' {{$cu->id}}')"href="#menus{{$cu->id}}" data-toggle="collapse" data-parent="#MainMenu"><i class="fa fa-chevron-down" aria-hidden="true" style="float: right; margin-right: -10px;" id="fontdrop{{$cu->id}}"></i></a>
                                                @endif
                                            </div>
                                                <div class="collapse" id="menus{{$cu->id}}">
                                                    ...
                                                    ?>
                                                    @if(count($catprod2) == 0 )
                                                        <a href="{{url('/kategori/'.$cat1->id.'/'.slugifyTitle($cat1->$nk).'/')}}" class="list-group-item" style="margin-left: 10px;">{{$cat1->$nk}}</a>
                                                    @else
                                                        <div class="list-group-item" style="margin-left: 10px;">
                                                            <a class='cat-prod' href="{{url('/kategori/'.$cat1->id.'/'.slugifyTitle($cat1->$nk).'/')}}"> {{$cat1->$nk}} </a>
                                                            ...
                                                            <div class="collapse" id="menus{{$cat1->id}}">
                                                                ...
                                                                ?>
                                                                <a href="{{url('/kategori/'.$cat2->id.'/'.slugifyTitle($cat2->$nk).'/')}}" class="list-group-item" style="margin-left: 20px;">{{$cat2->$nk}}</a>
                                                                @endforeach
                                                            </div>
                                                    @endif
                                                    @endforeach
                    ...
                    <aside class="sidebar_widget">
                        <div class="widget_inner" style="background : #e9e9ff !important">
                            <div class="widget_list widget_categories" style="background : #e9e9ff !important">
                                ...
                                @if(isset($page))
                                    <select class="form-control" id="cari_cat_advance" name="cari_cat_advance" disabled placeholder="@lang('frontend.home.caricategory')" style="    border: 1
                                    px
                                     solid rgb(170, 170, 170); font-size: 12px;margin-bottom: 20px; border-radius:10px; background: #d1d1e5; color:#000">
                                        <option></option>
                                    </select>
                                @else
                                    <select class="form-control" id="cari_cat_advance" name="cari_cat_advance" placeholder="@lang('frontend.home.caricategory')" style="    border: 1
                                    px
                                     solid rgb(170, 170, 170); font-size: 12px;margin-bottom: 20px; border-radius:10px; background: #d1d1e5; color:#000">
                                        <option></option>
                                    </select>
                                ...
                                <ul id="highlightlist" style="margin-bottom: 0px;">
                                    <li>
                                    @if(isset($page))
                                        <input type="radio" name="inlineRadioOptions" value="hot" id="exampleRadios1" class="check_hl" onclick="getProduct(this.value, this.checked)" disabled {{$checkedhot}}>
                                    @else
                                        <input type="radio" name="inlineRadioOptions" value="hot" id="exampleRadios2" class="check_hl" onclick="getProduct(this.value, this.checked)" {{$checkedhot}}>
                                    @endif
                                    ...
                                    <li>
                                    @if(isset($page))
                                        <input type="radio" name="inlineRadioOptions" value="new" id="exampleRadios1" class="check_hl" onclick="getProduct(this.value, this.checked)" disabled {{$checkedna}}>
                                    @else
                                        <input type="radio" name="inlineRadioOptions" value="new" id="exampleRadios2" class="check_hl" onclick="getProduct(this.value, this.checked)" {{$checkedna}}>
                                    @endif
                            ...
                            <div class="widget_list widget_categories">
                                ...
                                ?>
                                @if(isset($page))
                                <input type="text" class="form-control" id="cari_manufacture" placeholder="{{$srchmanlang}}" style="     border: 1
                                px
                                ...
                                <ul id="manufacturlist">
                                    @foreach($manufacturer as $man)
                                        ...
                                        <li>
                                        @if(isset($page))
                                            <input type="radio"  value="{{$man->id}}" onclick="getProductbyEksportir(this.value, this.checked)" disabled {{$checkednya}}>
                                        @else
                                            <input type="radio"  value="{{$man->id}}" onclick="getProductbyEksportir(this.value, this.checked)" {{$checkednya}}>
                                        @endif
                                ...
                                <hr>
                                    <button style="font-weight:bold; background-color: #ffe300; color: #1d7bff; border-radius: 15px;" class="btn" type="submit" name="search" id="search" form="formsprod">Search</button>
                            </div>
                        </div>
                    </aside>
                    <!--sidebar widget end-->
                ...
                <div class="mb-15 row">
                    <img src="{{asset('assets/assets/versi 1/Asset 30 (1).png')}}" class="d-block w-100" alt="...">

                    <div class="col-2" style="text-align: right;">
                        <div class="breadcrumb_content">  
                        @if(isset($page))
                            <select name="sortbyproduct" id="sortbyproduct" style="border: none;"class="sortproductnya" disabled>
                        ...
                        @else
                            <select name="sortbyproduct" id="sortbyproduct" style="border: none;"class="sortproductnya" >
                                        <option value="default" @if(isset($sortbyproduct)) @if($sortbyproduct == "default") selected @endif @endif>@lang('frontend.liseksportir.default')</option>
                                        <option value="new" @if(isset($sortbyproduct)) @if($sortbyproduct == "new") selected @endif @endif>@lang('frontend.liseksportir.newest')</option>
                                        @if(!empty(Auth::guard('eksmp')->user()))
                                            @if(Auth::guard('eksmp')->user()->status == 1)
                            ...
                            <div class="col-lg-4 col-md-4 col-12 ">
                                <div class="single_product" style="border: 0px!Important;height: {{$ukuran}}; background-color: #fdfdfc; padding: 0px !important;">
                                    ...
                                    <div class="product_thumb" align="center" style="background-color: #e8e8e4; height: 210px; border-radius: 0px 0px 0px 0px;">
                                        <a class="primary_img" href="{{url('/produk/'.slugifyTitle($categorynya).'/'.$pro->id.'/'.slugifyTitle($pro->prodname_en))}}" onclick="GoToProduct('{{$pro->id}}', event, this)"><img src="{{url('/')}}{{$isimg1}}" alt="" style="vertical-align: middle; height: {{$sizeImg}}px; border-radius: 0px 0px 0px 0px; padding: {{$padImg}}"></a>
                                    ...
                                    <div class="product_name grid_name" style="padding: 0px 13px 0px 13px;">
                                        ...
                                        <h3>
                                            <a href="{{url('/produk/'.slugifyTitle($categorynya).'/'.$pro->id.'/'.slugifyTitle($pro->prodname_en))}}" title="{{$prodn}}" class="href-name" onclick="GoToProduct('{{$pro->id}}', event, this)"><b>{{$prodnama}}</b></a>
                                        </h3>
                                    ...
                                    <div class="product_content list_content" style="width: 100%;">
                                        <div class="left_caption">
                                            <div class="product_name">
                                                <h3>
                                                    <a href="{{url('/produk/'.slugifyTitle($categorynya).'/'.$pro->id.'/'.slugifyTitle($pro->prodname_en))}}" title="{{$prodn}}" class="href-name" style="font-size: 15px !important;" onclick="GoToProduct('{{$pro->id}}', event, this)"><b>{{$prodn}}</b></a>
                                                </h3>
                                                <h3>
                    ...
                    <!-- <div class="shop_toolbar t_bottom"> -->
                        <div class="pagination justify-content-center" style="loat: center;">
                           <!--  <ul>
