    ...
    <div class="col">
        <div class="card">
            <div class="card-header border-bottom">
              <h2 class="text-black">@if($page == 'view') View @else Form @endif Trade Update
              @if($page == 'view')<a href="{{route('perwakilan.research-corner.index')}}" style="float: right;" class="btn btn-danger button_form"> Back</a><br><br>@endif</h2>
            </div>
            <div class="card-body">
