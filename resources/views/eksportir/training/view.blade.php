    ...
    {{ csrf_field() }}
        ...
        @foreach($data as $val)
            <div class="card-header border-bottom">
                <h3 class="mb-0">View Aktivitas Pelatihan</h3>
            </div>
            <div class="card-body">
                <div class="form-row">
                ...
                <div class="form-row">
                    <div class="form-group col-sm-3">
                        ...
                        <select disabled class="atc form-control select2" required id="inside_outside"
                            ...
                            <option value="inside" @if($val->dalam_luar == 'inside')   @endif selected> Inside </option>
                            <option value="outside" @if($val->dalam_luar == 'outside')   @endif selected> Outside </option>
                        </select>
                    </div>
                </div>
                <div class="form-row">
