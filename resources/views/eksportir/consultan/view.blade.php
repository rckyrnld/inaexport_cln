        ...
        <div class="col">
            ...
            <div class="card">
                <div class="card-header border-bottom">
                    <h3 class="mb-0">View Consultan</h3>
                </div>
                @foreach ($data as $val)
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-sm-6">
                                <label>Name</label>
                                <input type="text" class="form-control" value="{{ $val->nama_pegawai }}" name="name">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-sm-6">
                                <label>Position</label>
                                <input disabled type="text" value="{{ $val->jabatan }}" class="form-control"
                                    name="posotion">
                            </div>
                        </div>
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            <div class="form-group col-sm-6">
                                ...
                                <input disabled type="text" value="{{ $val->pejabat }}" class="form-control"
                                    name="pejabat">
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-sm-6">
                                <a style="color: white" href="{{ URL::previous() }}" class="btn btn-danger pull-right"><i
                                        style="color: white"></i>
                                    Back
                                </a>
                            </div>
