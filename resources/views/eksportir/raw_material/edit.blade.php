                        ...
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                <div class="form-group col-sm-3 mb-2">
                                    ...
                                    <input type="hidden" value="{{$val->id}}" name="id_bahan">
                                </div>
                            </div>
                            {{-- <div class="form-row">
                                <div class="form-group col-sm-6 mb-2">
                                    <label><b>Domestic</b></label>
                                    <input onkeyup="sum();" type="text" value="{{ $val->lokal_persen }}"
                                        class="form-control" max="100" name="domestic" id="domestic">
                                </div>
                            </div> --}}
                            <div class="form-row">
                                <div class="form-group col-sm-3 mb-2">
                                    <label><b>Domestic (%)</b></label>
                                    <input onkeyup="sum();" type="text" value="{{ str_replace(".", ",",$val->lokal_persen) }}"
                            ...
                            <div class="form-row">
                                <div class="form-group col-sm-3 mb-2">
                                    ...
                                    <input id="overseas" type="text" value="{{ str_replace(".",",",$val->impor_persen )}}"
                            ...
                            <div class="form-row">
                                <div class="form-group col-sm-3 mb-2">
                                    ...
                                    <input type="text" value="{{ str_replace(".",",", $val->nilai_impor )}}"
                                        class="form-control rupiah" name="valuefromdomestic" id="valuefromdomestic">
                                </div>
                            </div>
