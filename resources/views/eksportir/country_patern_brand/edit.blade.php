                ...
                <div class="card">
                    @foreach ($data as $val)
                        <div class="card-header border-bottom">
                            <h3 class="mb-0">Edit Negara Paten Merek</h3>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="form-group col-sm-3 mb-2">
                                    ...
                                    <select class="atc form-control select2" required id="brand" name="brand">
                                        ...
                                        @foreach ($brand as $sat)
                                            <option value="{{ $sat->id }}"
                                                {{ $val->id_itdp_eks_product_brand == $sat->id ? 'selected' : '' }}>
                                                {{ $sat->merek }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="form-row btnkanan">
                                <div class="form-group col-sm-12 ">
                                    <a style="color: white" href="{{ url('/eksportir/country_patern_brand') }}"
                                        class="btn btn-primary float right"><i style="color: white"></i>
                                        Back
                                    </a>
