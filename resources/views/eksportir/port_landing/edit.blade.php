                ...
                <div class="card">
                    @foreach ($data as $val)
                        <div class="card-header border-bottom">
                            <h3 class="mb-0">Edit Pelabuhan Ekspor</h3>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                <div class="form-group col-sm-3 mb-2">
                                    ...
                                    <input type="hidden" name="id_pelabuhan" value="{{$val->id}}">
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-sm-3">
                                    ...
                                    <select class="atc form-control select2" required id="port" name="port">
                                        <option value="">- Pilih Port -</option>
                                        @foreach ($port as $sa)
                                            <option value="{{ $sa->id }}"
                                                {{ $val->id_mst_port == $sa->id ? 'selected' : '' }}>
                                                {{ $sa->name_port }}
                                            </option>
                                        @endforeach
                                    </select>
