                ...
                <div class="card">
                    @foreach ($data as $val)
                        <div class="card-header border-bottom">
                            <h3 class="mb-0">Edit Aktivitas Pameran</h3>
                        </div>
                        <div class="card-body">
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                <div class="form-group col-sm-3 mb-2">
                                    <label><b>Exhibition</b></label>
                                    <select class="form-control select2" name="exhibition" id="exhibition">
                                        @foreach($exbition as $e)
                                        <option value="{{$e->id}}" @if($e->id == $val->id_itdp_eks_event_profil) selected @endif>{{$e->event_name_en}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-sm-3 mb-2">
                                    <label><b>Booth Area (Meters)</b></label>
                                    <input type="text" class="form-control rupiah"
                                        value="{{ $val->luas_boot }}" name="booth_area" id="booth_area" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-sm-3 mb-2">
                                    <label><b>Value Contract (USD)</b></label>
                                    <input type="text" class="form-control rupiah"
                                        value="{{ $val->nilai_kontrak }}" name="value_contract" id="value_contract">
                            ...
                            <div class="form-row">
                                <div class="form-group col-sm-3 mb-2">
                                    ...
                                    <select class="form-control select2" id="subsidi_djpen" name="subsidi_djpen">
                                        ...
                                        <option value="Y" {{ $val->subsidi == 'Y' ? 'selected' : '' }}>Yes</option>
                                        <option value="N" {{ $val->subsidi == 'N' ? 'selected' : '' }}>No</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-row rightbtn">
                                <div class="form-group col-sm-12">
                                    ...
                                    <button class="btn btn-success" type="submit"><i class="fa fa-plus-circle"></i> Update
                                    </button>
                                </div>
                            </div>
                        </div>
