                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content ">
                            <div class="tab-pane active" id="formprod">
                                ...
                                <div class="row">
                                    <label for="code" class="col-md-2"><b>Name</b></label>
                                    <div class="col-md-3">
                                    ...
                                    {{-- <div class="col-md-3">
                                        <input type="text" class="form-control" name="name_chn" id="name_chn"
                                            autocomplete="off">
                                    </div> --}}
                                </div><br>
                                <div class="row">
                                    <label for="code" class="col-md-2"><b>Field of Work</b></label>
                                    <div class="col-md-3">
                                        <div class="form-group" style="width: 80%; height: 35px">
                                            <input type="checkbox" name="bidang_en[]" id="bidang_en" autocomplete="off"
                                                value="Pre Production" onclick="bidang_1(1)"/>
                                        ...
                                        <div class="form-group" style="width: 80%; height: 35px">
                                            <input type="checkbox" name="bidang_en[]" id="bidang_en_2" autocomplete="off"
                                                value="Production" onclick="bidang_2(1)"/>
                                            <div class="btn-group" style="width: 100%; height: 100%;">
                                        ...
                                        <div class="form-group" style="width: 80%; height: 35px">
                                            <input type="checkbox" name="bidang_en[]" id="bidang_en_3" autocomplete="off"
                                                value="Post Production" onclick="bidang_3(1)"/>
                                            <div class="btn-group" style="width: 100%; height: 100%;">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group" style="width: 80%; height: 35px">
                                            <input type="checkbox" name="bidang_ind[]" id="bidang_ind" autocomplete="off"
                                                value="Pre Produksi" onclick="bidang_1(2)" />
                                            <div class="btn-group" style="width: 100%; height: 100%;">
                                        ...
                                        <div class="form-group" style="width: 80%; height: 35px">
                                            <input type="checkbox" name="bidang_ind[]" id="bidang_ind_2" autocomplete="off"
                                                value="Produksi" onclick="bidang_2(2)"/>
                                            <div class="btn-group" style="width: 100%; height: 100%;">
                                        ...
                                        <div class="form-group" style="width: 80%; height: 35px">
                                            <input type="checkbox" name="bidang_ind[]" id="bidang_ind_3" autocomplete="off"
                                                value="Pasca Produksi" onclick="bidang_3(2)"/>
                                            <div class="btn-group" style="width: 100%; height: 100%;">
                                    ...
                                    <div class="col-md-3">
                                        {{-- <div class="form-group" onclick="bidang_1(3)" style="width: 80%; height: 35px">
                                            <input type="checkbox" name="bidang_chn[]" id="bidang_chn" autocomplete="off"
                                                value="预生产" />
                                            <div class="btn-group" style="width: 100%; height: 100%;">
                                                <label for="bidang_chn" class="btn btn-default border-color"
                                                    style="border-color: #aeb5b7; width: 25%; height: 100%;">
                                                    <span class="fa fa-check" style="font-size: 16px"></span>
                                                    <span></span>
                                                </label>
                                                <label for="bidang_chn" class="btn btn-default active border-color"
                                                    style="border-color: #aeb5b7; width: 75%; height: 100%;">
                                                    预生产
                                                </label>
                                            </div>
                                        ...
                                        {{-- <div class="form-group" onclick="bidang_2(3)" style="width: 80%; height: 35px">
                                            <input type="checkbox" name="bidang_chn[]" id="bidang_chn_2" autocomplete="off"
                                                value="生产" />
                                            <div class="btn-group" style="width: 100%; height: 100%;">
                                                <label for="bidang_chn_2" class="btn btn-default border-color"
                                                    style="border-color: #aeb5b7; width: 25%; height: 100%;">
                                                    <span class="fa fa-check" style="font-size: 16px"></span>
                                                    <span></span>
                                                </label>
                                                <label for="bidang_chn_2" class="btn btn-default active border-color"
                                                    style="border-color: #aeb5b7; width: 75%; height: 100%;">
                                                    生产
                                                </label>
                                            </div>
                                        ...
                                        {{-- <div class="form-group" onclick="bidang_3(3)" style="width: 80%; height: 35px">
                                            <input type="checkbox" name="bidang_chn[]" id="bidang_chn_3" autocomplete="off"
                                                value="后期制作" />
                                            <div class="btn-group" style="width: 100%; height: 100%;">
                                                <label for="bidang_chn_3" class="btn btn-default border-color"
                                                    style="border-color: #aeb5b7; width: 25%; height: 100%;">
                                                    <span class="fa fa-check" style="font-size: 16px"></span>
                                                    <span></span>
                                                </label>
                                                <label for="bidang_chn_3" class="btn btn-default active border-color"
                                                    style="border-color: #aeb5b7; width: 75%; height: 100%;">
                                                    后期制作
                                                </label>
                                            </div>
                                ...
                                <div class="row">
                                    <label for="code" class="col-md-2"><b>Skills</b></label>
                                    <div class="col-md-3">
                                        <textarea class="form-control" autocomplete="off" name="skill_en"
                                            id="skill_en"></textarea>
                                    </div>
                                    <div class="col-md-3">
                                        <textarea class="form-control" autocomplete="off" name="skill_ind"
                                            id="skill_ind"></textarea>
                                    </div>
                                    {{-- <div class="col-md-3">
                                        <textarea class="form-control" autocomplete="off" name="skill_chn"
                                            id="skill_chn"></textarea>
                                    </div> --}}
                                </div><br>
                                <div class="row">
                                    <label for="code" class="col-md-2"><b>Experiences ( EN )</b></label>
                                    <div class="col-md-6">
                                        <textarea class="form-control" id="experience_en" name="experience_en"></textarea>
                                    </div>
                                </div><br>
                                <div class="row">
                                    <label for="code" class="col-md-2"><b>Experiences ( IND )</b></label>
                                    <div class="col-md-6">
                                        <textarea class="form-control" id="experience_ind"
                                            name="experience_ind"></textarea>
                                    </div>
                                </div><br>
                                {{-- <div class="row">
                                    <label for="code" class="col-md-3"><b>Experiences ( CHN )</b></label>
                                    <div class="col-md-6">
                                        <textarea class="form-control" id="experience_chn"
                                            name="experience_chn"></textarea>
                                    </div>
                                </div><br> --}}
                                <div class="row">
                                    <label for="code" class="col-md-2"><b>Links</b></label>
                                    <div class="col-md-6">
                                        <textarea class="form-control" id="link" name="link"></textarea>
                                    </div>
                                </div><br>
                                <div class="row">
                                    <label for="code" class="col-md-2"><b>Show Services</b></label>
                                    <div class="col-md-9">
                                    ...
                                    <div class="col-md-12">
                                        <div style="float: right;">
                                            <a class="btn btn-danger lebar_btn"
                                                href="{{ url('eksportir/service') }}">Cancel</a>
                                            <button type="submit" class="btn btn-primary lebar_btn"
