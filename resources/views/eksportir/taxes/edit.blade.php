                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-sm-3 mb-2">
                                ...
                                <select class="atc form-control select2" required id="year" name="year">
                                    ...
                                    @foreach ($years as $sa)
                                    <option value="{{ $sa }}" {{ $val->tahun == $sa ? 'selected' : '' }}>
                                        {{ $sa }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-sm-3 mb-2">
                                ...
                                <select class="form-control" name="laporan_pph">
                                    ...
                                    <option value="Sudah" {{ ($val->laporan_pph == 'Sudah') ? 'selected' : '' }}>Sudah
                                    </option>
                                    <option value="Belum" {{ ($val->laporan_pph == 'Belum') ? 'selected' : '' }}>Belum
                                    </option>
                                </select>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-sm-3 mb-2">
                                ...
                                <select class="form-control" name="laporan_ppn">
                                    <option value="">-- Choose Status --</option>
                                    <option value="Sudah" {{ ($val->laporan_ppn == 'Sudah') ? 'selected' : '' }}>Sudah
                                    </option>
                                    <option value="Belum" {{ ($val->laporan_ppn == 'Belum') ? 'selected' : '' }}>Belum
                                    </option>
                                </select>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="form-group col-sm-3 mb-2">
                                ...
                                <select class="form-control" name="laporan_pasal_21">
                                    <option value="">-- Choose Status --</option>
                                    <option value="Sudah" {{ ($val->laporan_psl21 == 'Sudah') ? 'selected' : '' }}>Sudah
                                    </option>
                                    <option value="Belum" {{ ($val->laporan_psl21 == 'Belum') ? 'selected' : '' }}>Belum
                                    </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-sm-3 mb-2">
                                ...
                                <input type="text" value="{{ $val->tunggakan_ppn }}"
                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-sm-3 mb-2">
                                ...
                                <input type="text" value="{{ $val->tunggakan_psl21 }}"
                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
