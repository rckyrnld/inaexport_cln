...
@section('content')
        ...
        <div class="col">
            <div class="card">
                <div class="card-header border-bottom">
                    <h3 class="mb-0">Form Tambah Tujuan Ekspor</h3>
                </div>
                <div class="card-body">
                    ...
                    <form class="form-horizontal" enctype="multipart/form-data" method="POST" action="{{ url($url) }}">
                        ...
                        <div class="form-row">
                            <div class="form-group col-sm-3 mb-2">
                                ...
                                <input type="text" class="form-control amount" name="ratio_export" id="ratio_export">
                            </div>
                        </div>
    ...
    $("#ratio_export").keyup(function(){
        var ratio_export = $('#ratio_export').val().replace(',','.');
        var max = 100;
        if(ratio_export > max){
            $('#ratio_export').addClass('input-error');
            $("#btnSubmit").attr("type","button");
            $("#btnSubmit").attr("onclick","notifAlert()");
        }else{
            $('#ratio_export').removeClass('input-error');
    ...
    function notifAlert(){
        alert('Ratio Export Melebihi 100');
    }
    </script>
