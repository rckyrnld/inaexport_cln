                        ...
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                <div class="form-group col-sm-3 mb-2">
                                    ...
                                    <input type="text" value="{{ $val->name }}" name="name" id="name"
                                        class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-sm-3 mb-2">
                                    ...
                                    <input type="text" class="form-control" value="{{ $val->job_title }}"
                            ...
                            <div class="form-row">
                                <div class="form-group col-sm-3 mb-2">
                                    ...
                                    <input type="text" class="form-control" value="{{ $val->phone }}" name="phone"
                                        id="phone">
