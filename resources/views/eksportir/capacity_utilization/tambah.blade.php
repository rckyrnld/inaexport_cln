        ...
        <div class="col">
            <div class="card">
                <div class="card-header border-bottom">
                    <h3 class="mb-0">Form Tambah Utilisasi Kapasiti</h3>
                </div>
                <div class="card-body">
                    ...
                    <form class="form-horizontal" enctype="multipart/form-data" method="POST" action="{{ url($url) }}">
                        ...
                        <div class="form-row">
                            <div class="form-group col-sm-3 mb-2">
                                ...
                                <input type="text"
                                    class="form-control amount" max="100" name="used_capacity" id="used_capacity">
                            </div>
                        </div>
                        <div class="form-row rightbtn">
                            <div class="form-group col-sm-12">
                                <a style="color: white" href="{{ url('/eksportir/capulti') }}" class="btn btn-danger"><i
                                        style="color: white"></i>
                                    Back
                                </a>
