            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row mb-2 ml-4 mt-2">
                        <div class="col-lg-12">
                            @php
                                $cari_provinsi = request()->get('cari_provinsi');
                            ...
                            <form class="mb-0" method="post" action="{{ url('annual_sales/cetak') }}">
                                ...
                                <input type="hidden" name="cari_provinsi"
                                    value="{{ $cari_provinsi != '' ? $cari_provinsi : $provinsi }}">
                    ...
                    <div class="row">
                            ...
                            <form class="form-horizontal" enctype="multipart/form-data" method="GET"
                                ...
                                <div class="row">
                                    <div class="col-md-3 ml-3 mt-2">
                                        <select onchange="this.form.submit()" class="form-control" id="cari_provinsi"
                                            name="cari_provinsi" placeholder="Choose Province"
                                            ...
                                            @foreach ($mst as $cu)
                                                {
                                                <option value="{{ $cu->id }}"
                                                    @if (isset($provinsi)) @if ($provinsi == $cu->id)
                                            selected @endif
                                                    @endif>
                                                    {{ $cu->province_en }}
                                                </option>
                        ...
                        <div class="col-12 col-sm-4 text-right">
                            <form action="{{ url('/') }}/eksportir/admin/perwadag_search" method="POST" role="search">
                                {{ csrf_field() }}
                    ...
                    <div class="row shop_wrapper" id="catlist">
                                    ...
                                    <div class="product_content grid_content h-100 d-flex flex-column table-responsive"
                                            ...
                                            <div class="eksporter-detail mt-auto"
                                                ...
                                                <center>
                                                    <a href="{{ url('front_end/list_perusahaan/view/' . ($param = $eks->id_user . '-' . getCompanyName($eks->id_user)) . '-' . $kategori) }}"
                                                        class="btn btneksportir cardreport" style="border-radius: 15px; background-color: #ffe300; color:#1d7bff; font-size : 14px; font-weight : bold;
                                                                                            width : 150 px;">Detail</a>
                                                    </a>
                                        ...
                                        @else
                                            <div class="eksporter-detail mt-auto"
                                                style="border-top: 1px solid #DDEFFD; padding: 2%;">
                                                <center>
                                                    <a href="{{ url('front_end/list_perusahaan/view/' . ($param = $eks->id_user . '-' . getCompanyName($eks->id_user))) }}"
                                                        class="btn btneksportir cardreport" style="border-radius: 15px; background-color: #ffe300; color:#1d7bff; font-size : 14px; font-weight : bold;
                                                                                            width : 150 px;">Detail</a>
                                                    </a>
                                                    ...
                                                    <a href="{{ url('front_end/list_perusahaan/view/' . $eks->id_user . '-' . $eks->company . '/all/send') }}#tabs-icons-text-3-tab"
                                                    ...
                                                    <a href="{{ url('/chat_admin_eks_imp/' . encrypt(Auth::user()->id) . '/' . encrypt($eks->id_user)) }}"
                                                        class="btn btn-success">
