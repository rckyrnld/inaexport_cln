        ...
        <div class="col">
            <div class="card">
                <div class="card-header border-bottom">
                    <h3 class="mb-0">Form Tambah Penjualan</h3>
                </div>
                <div class="card-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-sm-3 mb-2">
                                ...
                                <input type="text"
                                    ...
                                    class="form-control amount" name="value" id="value" required>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-sm-3 mb-2">
                                ...
                                <input onkeyup="sum();" type="text"
                                    class="form-control persen" name="persen" id="persen">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-sm-3 mb-2">
                                <label><b>Export Value (USD)</b></label>
                                <input readonly type="text"
                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                                    class="form-control amount" name="nilai_ekspor" id="nilai_ekspor" required>
                            </div>
                        </div>
