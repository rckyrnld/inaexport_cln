...
<table style="margin-bottom:25px" class="table table-bordered table-light black">
    <thead class="thead-light">
        <tr>
            <td style="color:black !important; font-size:14px !important" width="10%" class="table-active">Company</td>
            <td style="color:black !important; font-size:14px !important" width="10%" class="table-active">Address</td>
            <td style="color:black !important; font-size:14px !important" width="10%" class="table-active">Province</td>
            <td style="color:black !important; font-size:14px !important" width="10%" class="table-active">Email</td>
            <td style="color:black !important; font-size:14px !important" width="10%" class="table-active">PIC Name</td>
            <td style="color:black !important; font-size:14px !important" width="10%" class="table-active">PIC Telephone
            </td>
            <td style="color:black !important; font-size:14px !important" width="20%" class="table-active">Verify Date
            </td>
        </tr>
    </thead>
    <tbody>
        <td style="color:black !important; font-size:14px !important">
...
<table style="margin-bottom:25px" class="table table-bordered table-light black">
    <thead class="thead-light">
        <tr>
            ...
            <td style="color:black !important; font-size:14px !important" width="20%" class="table-active">Meaning of
                brand</td>
            ...
            <td style="color:black !important; font-size:14px !important" width="20%" class="table-active">Copyright
                Number</td>
        </tr>
    </thead>
...
<table style="margin-bottom:25px" class="table table-bordered table-light black">
    <thead class="thead-light">
        <tr>
            <td style="color:black !important; font-size:14px !important" width="20%" class="table-active">Year</td>
            <td style="color:black !important; font-size:14px !important" width="20%" class="table-active">Country</td>
            <td style="color:black !important; font-size:14px !important" width="20%" class="table-active">Ratio Export
            </td>
        </tr>
    </thead>
...
<table style="margin-bottom:25px" class="table table-bordered table-light black">
    <thead class="thead-light">
        <tr>
            <td style="color:black !important; font-size:14px !important" width="20%" class="table-active">Exhibition
            </td>
            <td style="color:black !important; font-size:14px !important" width="20%" class="table-active">Booth Area
            </td>
            <td style="color:black !important; font-size:14px !important" width="20%" class="table-active">Value
                Contract</td>
...
<table style="margin-bottom:25px" class="table table-bordered table-light black">
    <thead class="thead-light">
        <tr>
            <td style="color:black !important; font-size:14px !important" width="20%" class="table-active">Year</td>
            <td style="color:black !important; font-size:14px !important" width="20%" class="table-active">Local
                Employee</td>
            <td style="color:black !important; font-size:14px !important" width="20%" class="table-active">Foreign
                Worker</td>
        </tr>
    </thead>
    <tbody>
...
<table style="margin-bottom:25px" class="table table-bordered table-light black">
    <thead class="thead-light">
        <tr>
            ...
            <td style="color:black !important; font-size:14px !important" width="20%" class="table-active">Organizer
            </td>
            <td style="color:black !important; font-size:14px !important" width="20%" class="table-active">Start Date
            </td>
...
<table style="margin-bottom:25px" class="table table-bordered table-light black">
    <thead class="thead-light">
        <tr>
            <td style="color:black !important; font-size:14px !important" width="20%" class="table-active">Year</td>
            <td style="color:black !important; font-size:14px !important" width="20%" class="table-active">Report PPH
            </td>
            <td style="color:black !important; font-size:14px !important" width="20%" class="table-active">Report PPN
            </td>
            <td style="color:black !important; font-size:14px !important" width="20%" class="table-active">Report Pasal
                21</td>
            <td style="color:black !important; font-size:14px !important" width="20%" class="table-active">Total PPH
            </td>
        </tr>
    </thead>
    <tbody>
...
<!--Product-->
<h4><b>Product</b></h4>
<table class="table table-bordered table-light black">
    <thead class="thead-light">
        <tr>
            <td style="color:black !important; font-size:14px !important" width="20%" class="table-active">Code</td>
            <td style="color:black !important; font-size:14px !important" width="20%" class="table-active">Product Name
            </td>
            ...
            <td style="color:black !important; font-size:14px !important" width="20%" class="table-active">Raw Material
            </td>
        </tr>
    </thead>
...
<table style="margin-bottom:25px" class="table table-bordered table-light black">
    <thead class="thead-light">
        ...
        <tr>
            ...
            <td style="color:black !important; font-size:14px !important" width="20%" class="table-active">Price (USD)
            </td>
            ...
            <td style="color:black !important; font-size:14px !important" width="20%" class="table-active">Information
            </td>
        </tr>
    </thead>
...
<table style="margin-bottom:10px" class="table table-bordered table-light black">
    <thead class="thead-light">
        <tr>
            <td style="color:black !important; font-size:14px !important" width="20%" class="table-active">Name</td>
            <td style="color:black !important; font-size:14px !important" width="20%" class="table-active">Field of
                Works</td>
