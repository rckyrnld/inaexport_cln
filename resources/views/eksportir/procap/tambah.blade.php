            ...
            <form class="form-horizontal" enctype="multipart/form-data" method="POST" action="{{ url($url) }}">
                ...
                <div class="card">
                    <div class="card-header border-bottom">
                        <h3 class="mb-0">Form Tambah Kapasitas Produksi</h3>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-sm-3 mb-2">
                                ...
                                <input onkeyup="sum();" type="text" class="form-control amount" name="persen_sendiri" id="persen_sendiri"
                                    required>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-sm-3 mb-2">
                                ...
                                <input type="text" class="form-control amount" name="out_persen" id="out_persen" readonly>
                            </div>
                        ...
                        <div class="form-row rightbtn">
                            <div class="form-group col-sm-12">
                                ...
                                <button class="btn btn-primary" id="btnSubmit" type="button"> Submit
                                </button>
                            </div>
                        </div>
                    </div>
