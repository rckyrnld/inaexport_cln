...
?>
  ...
  <table id="tablebureq" border="0" class="table table-bordered table-striped">
								...
								<tr>
									...
									<td><center><?php if($ruu->status_transaksi == 1){ echo "<span class='badge bg-success' style='color: #fff;'>Already Sent</span>"; }else{ echo "<span class='badge bg-danger' style='color: #fff;'>On Process</span>"; } ?></center></td>
