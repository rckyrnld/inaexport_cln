			...
			<div class="form-row" style="font-size:12px;">
				...
				<div class="col-5">
					...
					?>
						<div class="form-row">
							...
							<div class="form-group col-sm-6">
								<input class="form-control" type="text" value="<?php if ($p3->origin == 1) {
																					echo "Inquiry";
																				} else {
																					echo "Buying Request";
																				} ?>" readonly>
					...
					<div class="form-row">
						...
						<div class="form-group col-sm-6">
							<select <?php if ($p2->status_trx == 1) {
										echo "readonly";
									} ?> class="form-control" name="type_tracking" required readonly>
								<option value="">- Select Tracking Type -</option>
								<option <?php if ($p3->type_tracking == "DHL Express") {
											echo "selected";
										} ?> value="DHL Express">DHL Express</option>
								<option <?php if ($p3->type_tracking == "DHL Active Tracing") {
											echo "selected";
										} ?> value="DHL Active Tracing">DHL Active Tracing</option>
								<option <?php if ($p3->type_tracking == "DHL Global Forwarding") {
											echo "selected";
										} ?> value="DHL Global Forwarding">DHL Global Forwarding</option>
								<option <?php if ($p3->type_tracking == "Fedex") {
											echo "selected";
										} ?> value="Fedex">Fedex</option>
								<option <?php if ($p3->type_tracking == "Fedex Freight") {
											echo "selected";
										} ?> value="Fedex Freight">Fedex Freight</option>
								<option <?php if ($p3->type_tracking == "FedEx Ground") {
											echo "selected";
										} ?> value="FedEx Ground">FedEx Ground</option>
								<option <?php if ($p3->type_tracking == "China EMS") {
											echo "selected";
										} ?> value="China EMS">China EMS</option>
								<option <?php if ($p3->type_tracking == "Deutsche Post DHL") {
											echo "selected";
										} ?> value="Deutsche Post DHL">Deutsche Post DHL</option>
								<option <?php if ($p3->type_tracking == "Other") {
											echo "selected";
				...
				<div class="form-row">
					...
					<div class="form-group col-sm-3">
						<input type="number" name="eo" class="form-control" value="<?php if (empty($p3->eo)) {
																						echo "1";
																					} else {
																						echo $p3->eo;
																					} ?>" readonly>
				...
				<div class="form-row">
					...
					<div class="form-group col-sm-3">
						...
						<input readonly type="text" name="tp" class="amount form-control" value="<?php if (empty($p3->tp) || $p3->tp == null) {
																										echo "0";
																									} else {
																										echo number_format($p3->tp, 0, ',', '.');
																									} ?>">
					</div>
					<div class="form-group col-sm-3">
				...
				<div class="form-row">
					...
					<div class="form-group col-sm-6">
						<select <?php if ($p3->status_transaksi == 1) {
									echo "readonly";
				...
				<div class="form-row">
					...
					<div class="form-group col-sm-6">
						<input class="form-control" type="text" id="no_track" name="no_track" value="<?php echo $p3->no_tracking; ?>" <?php if ($p3->status_transaksi == 1) {
																																			echo "readonly";
																																		} ?>>
				...
				<div class="form-row">
					...
					<div class="form-group col-sm-6">
						<input class="form-control" type="text" id="link_tracking" name="link_tracking" value="<?php echo $p3->link_tracking; ?>" <?php if ($p3->status_transaksi == 1) {
																																						echo "readonly";
																																					} ?>>
					</div>
				</div>
