        ...
        <div class="col">
            <div class="card">
                <div class="card-header border-bottom">
                    <h3 class="mb-0">List Province</h3>
                </div>
                <div class="card-body pl-0 pr-0">
                    ...
                    @endif
                    <a id="tambah" href="{{ route('master.province.create') }}" class="btn btn-primary ml-4"> <i
                            class="fa fa-plus-circle"></i> Add </a>&nbsp;&nbsp;
                    <a id="export" href="{{ route('master.province.export') }}" class="btn btn-success" target="_blank"><i
                    ...
                    <div class="table-responsive">
                        <table id="table" class="table table-striped table-hover" data-plugin="dataTable">
                            <thead class="text-white" style="background-color: #6B7BD6;">
                                <tr>
                                    <th width="29%">
                                        <center>Province (EN)</center>
                                    </th>
                                    <th width="29%">
                                        <center>Province (IN)</center>
                                    </th>
                                    <th width="26%">
                                        <center>Province (CHN)</center>
                                    </th>
                                    <th width="20%">
