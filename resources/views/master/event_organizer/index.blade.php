        ...
        <div class="col">
            <div class="card">
                <div class="card-header border-bottom">
                    <h3 class="mb-0">Event Organizer</h3>
                </div>
                ...
                <div class="card-body">
                    ...
                    @endif
                    <a href="{{ route('master.event_organizer.create') }}" class="btn btn-primary ml-5"><i
                            class="fa fa-plus-circle"></i>&nbsp;Add</a><br /><br />

                    <table id="table" class="table table-striped table-hover display nowrap" data-plugin="dataTable">
    ...
    <script>
        $(function() {
            ...
            $('#table').DataTable({
                ...
                scrollX: true,
                ajax: {
                    "url": '{!! route('master.event_organizer.getData') !!}',
                    "dataType": "json",
                    "type": "POST",
                    "data": {
                        _token: '{{ csrf_token() }}'
