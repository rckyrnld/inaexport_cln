            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row mb-2">
                            <div class="col-md-1"></div>
                            <label class="control-label col-md-1 my-auto">Contact Person</label>
                            <div class="col-md-7">
                                <input type="text" class="form-control" id="contact_person" autocomplete="off" name="contact_person"
                                    placeholder="Input Contact Person" required {{ $view }} @isset($data)
                                    value="{{ $data->contact_person }}" @endisset>
                            </div>
                        </div>
