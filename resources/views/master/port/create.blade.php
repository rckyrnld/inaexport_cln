                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    <div class="col-md-1"></div>
                      <label class="control-label col-md-2 mt-2">ID</label>
                      <div class="col-md-7">
                  ...
                  <div class="form-group row">
                    <div class="col-md-1"></div>
                      <label class="control-label col-md-2 mt-2">Province</label>
                      <div class="col-md-7">
                  ...
                  <div class="form-group row">
                    <div class="col-md-1"></div>
                      <label class="control-label col-md-2 mt-2">Port</label>
                      <div class="col-md-7">
                  ...
                  <div class="form-group row">
                    <div class="col-md-10">
                      <div align="right">
                        ...
                        @endif
                        <a href="{{route('master.port.index')}}" class="btn btn-danger button_form">@if($page != 'view') Cancel @else <i class="fas fa-arrow-circle-left"></i> Back @endif</a>
                      </div>
                    </div>
                  </div>
