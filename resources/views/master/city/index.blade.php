        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-body pl-0 pr-0">
                    ...
                    @endif
                    <a id="tambah" href="{{ route('master.city.create') }}" class="btn btn-primary ml-4"> <i
                            class="fa fa-plus-circle"></i> Add </a>&nbsp;&nbsp;
                    <a id="export" href="{{ route('master.city.export') }}" class="btn" target="_blank"><i
